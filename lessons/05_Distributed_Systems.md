# A small intro to distributed systems.

## Table of Contents
* [What is a distributed system?](#what is a distributed system?)
* [Nodes and networks](#nodes and networks)
* [Low level protocols](#low level protocols)
* [Clocks](#clocks)
* [Availability](#availability)
* [Consistency](#consistency)
* [Tradeoffs](#tradeoffs)
* [Avoid Consensus Wherever Possible](#avoid consensus wherever possible)
* [Fine, We Need Consensus, What Now?](#fine, we need consensus, what now?)
* [Characteristic latencies](#characteristics latencies)
* [Common distributed systems](#common distributed systems)
...
* First glance: internal servers (Windows/Linux), running processes communicating via TCP or UDP.
  * Or VM's in EC2, Google Cloud, etc
  * Maybe communicating over localhost
...
- Nodes interact via a *network*
  ...
  - Computers interact via IP, or UDP, or ...
...
- But wait, there's more!
  ...
  - Other theorems disallow totally or sticky available (http://www.bailis.org/blog/stickiness-and-client-server-session-guarantees/)
    - Strong serializable
    - Serializable
    - Repeatable Read
    - Cursor Stability
...
## Notes
Most of this content has been adapted (copyed) from: https://github.com/aphyr/distsys-class. I've removed some parts of it to make it somewhat shorter.
